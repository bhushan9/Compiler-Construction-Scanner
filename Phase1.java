...
public class Phase1 {
   ...
   // static int[] accepted_states=new int[]{1,2};
    ...
    public static String getType(int state)
    {
       ...
       switch(state)
       {
           case 0: state_type="Initial state"; // initial state
                    break;
           case 1: state_type="<identifier>"; // identifier
                    break;
           case 2: state_type="<number>";// number
                    break;
           case 3: state_type="<symbol>";  // symbol
                    break;
           case 4: state_type="<ws>"; // ws
                    break;
           case 5: state_type="<string>"; // string
                    break;
           case 6: state_type="<meta>";  //meta
                    break;
           case 7: state_type="<reserved word>"; // reserved state
                    break;
           case 8: state_type="<statement_end>"; // statement end
                    break;
                     
           case 9: state_type="<invalid>";  // invalid       
